...
// #if !STM32MP_M33_TDCID
{
    ...
    /*
     * 步骤 1: 使能 RIFSC 和 RISAB4 的时钟。
     * 必须在访问这些外设之前完成。
     */
    uintptr_t rcc_secensetr = stm32mp_rcc_base() + CUSTOM_RCC_SECENSETR_OFFSET;
    mmio_setbits_32(rcc_secensetr, CUSTOM_RCC_SECENSETR_RIFSCEN |
    ...
    mmio_write_32(RISAB4_BASE + RISAB_ACR1_OFFSET,
                  BUILD_ACR_FIELD(M33_NS_MASTER_ID, PERM_READ_WRITE));
